...
| B8 | Monorepo ecosystem: PWA + desktop + mobile | 86% | Shared ops-console, ops-network, mission-story, wallet selector, transfer-story, finance-story, assistant-story/persona, analyst-story, wallet-tool-story, network-token-story, QVAC-story, RAG-story, intel-story, station-story, and brand-story contracts feed PWA, desktop/mobile scaffolds, cards, transfers, dossier routing, notifications, metadata, native model identity, and SPY presets. Native adapters still missing. |
