...
export const LECLERC_ASSETS = {
  ...
  mxnb: {
    ...
    strategy: "Hyperlane",
    addresses: {
      5042002: "0x836F73Fbc370A9329Ba4957E47912DfDBA6BA461",
      42161: "0xF197FFC28c23E0309B5559e7a166f2c6164C80aA",
    },
    source: "../defi-web-app/packages/contracts/deployments/asset-registry/testnet.json",
  },
  qcad: {
    ...
    strategy: "Hyperlane",
    addresses: {
      5042002: "0x23d7CFFd0876f3ABb6B074287ba2aeefBc83825d",
    },
    source: "../defi-web-app/packages/contracts/deployments/asset-registry/testnet.json",
  },
  audf: {
    ...
    strategy: "Hyperlane",
    addresses: {
      5042002: "0xd2a530170D71a9Cfe1651Fb468E2B98F7Ed7456b",
    },
    source: "../defi-web-app/packages/contracts/deployments/asset-registry/testnet.json",
  },
  jpyc: {
    ...
    strategy: "Hyperlane",
    addresses: {
      5042002: "0xE7C3D8C9a439feDe00D2600032D5dB0Be71C3c29",
    },
    source: "../defi-web-app/packages/contracts/deployments/asset-registry/testnet.json",
  },
  cirbtc: {
    ...
    strategy: "Hyperlane",
    addresses: {
      5042002: "0xf0C4a4CE82A5746AbAAd9425360Ab04fbBA432BF",
    },
    source: "../defi-web-app/packages/contracts/deployments/asset-registry/testnet.json",
...
export function explorerTxUrl(chain: ChainCatalogEntry, hash: string): string {
  return `${chain.explorerBaseUrl}/${chain.explorerTxPath}/${hash}`;
}

export function explorerAddressUrl(chain: ChainCatalogEntry, address: string): string {
...
export function isWritableChain(chain: ChainCatalogEntry): boolean {
  return chain.writePolicy === "allowed-testnet";
}
