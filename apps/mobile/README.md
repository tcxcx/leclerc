...
entry. The next implementation step is to replace the placeholder worklet with
the QVAC/WDK/Hyperswarm adapter after rechecking installed SDK `.d.ts` files.
