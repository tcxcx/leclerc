...
not vendor Electron, Pear, QVAC, WDK, or Hyperswarm yet. The next implementation step is to add the
...
after rechecking installed SDK `.d.ts` files. The scaffold reports
